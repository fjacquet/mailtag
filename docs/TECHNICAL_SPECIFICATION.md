...
- **`db/sender_classification_db.json`**: This file is the source of truth for the classification system. It contains classifications that have been manually reviewed and approved by the user.
