...
class MailService:
    ...
    def _run_applescript(self, script: str) -> str:
        ...
        try:
            ...
            logging.error("`osascript` command not found. Is this running on macOS?")
            raise
...
"
        ...
        for line in raw_output.splitlines():
            ...
            try:
                ...
                logging.warning(f"Could not parse email line: {line} - {e}")
        return emails
    ...
    def get_email_body(self, email: Email) -> str:
        ...
        script = f"""
        tell application "Mail"
            set theMessage to message id {email.msg_id}
