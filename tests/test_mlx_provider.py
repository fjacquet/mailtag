...
class TestMLXEmbedder:
    ...
    def test_encode_query(self, mocker: MockerFixture):
...
class TestMLXLLM:
    ...
    def test_generate_basic(self, mocker: MockerFixture):
        ...
        mock_generate = mocker.MagicMock(return_value="  Generated response  ")
        mock_make_sampler = mocker.MagicMock(return_value=mocker.MagicMock())
        mock_sample_utils = mocker.MagicMock(make_sampler=mock_make_sampler)
        mock_mlx_lm = mocker.MagicMock(generate=mock_generate, sample_utils=mock_sample_utils)
        mocker.patch.dict(
            sys.modules,
    ...
    def test_classify_json_response(self, mocker: MockerFixture):
        ...
        mock_generate = mocker.MagicMock(return_value=json_response)
        mock_make_sampler = mocker.MagicMock(return_value=mocker.MagicMock())
        mock_sample_utils = mocker.MagicMock(make_sampler=mock_make_sampler)
        mock_mlx_lm = mocker.MagicMock(generate=mock_generate, sample_utils=mock_sample_utils)
        mocker.patch.dict(
    ...
    def test_classify_json_in_text(self, mocker: MockerFixture):
        ...
        mock_generate = mocker.MagicMock(return_value=response)
        mock_make_sampler = mocker.MagicMock(return_value=mocker.MagicMock())
        mock_sample_utils = mocker.MagicMock(make_sampler=mock_make_sampler)
        mock_mlx_lm = mocker.MagicMock(generate=mock_generate, sample_utils=mock_sample_utils)
        mocker.patch.dict(
    ...
    def test_classify_invalid_json(self, mocker: MockerFixture):
        ...
        mock_generate = mocker.MagicMock(return_value="Commerce/Amazon")
        mock_make_sampler = mocker.MagicMock(return_value=mocker.MagicMock())
        mock_sample_utils = mocker.MagicMock(make_sampler=mock_make_sampler)
        mock_mlx_lm = mocker.MagicMock(generate=mock_generate, sample_utils=mock_sample_utils)
        mocker.patch.dict(
    ...
    def test_classify_confidence_clamping(self, mocker: MockerFixture):
        ...
        mock_generate = mocker.MagicMock(return_value='{"category": "Test", "confidence": 1.5, "reason": ""}')
        mock_make_sampler = mocker.MagicMock(return_value=mocker.MagicMock())
        mock_sample_utils = mocker.MagicMock(make_sampler=mock_make_sampler)
        mock_mlx_lm = mocker.MagicMock(generate=mock_generate, sample_utils=mock_sample_utils)
        mocker.patch.dict(
